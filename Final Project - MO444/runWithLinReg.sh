...
SIGM_STEEP_GRAD_VAL="$(python python/linearRegr.py train_data/baseGradFeats.csv train_data/basePropVals.csv 1 tmp/_nosigm_grad.pgm)"
SIGM_x0_GRAD_VAL="$(python python/linearRegr.py train_data/baseGradFeats.csv train_data/basePropVals.csv 2 tmp/_nosigm_grad.pgm)"
SIGM_STEEP_SAL_VAL="$(python python/linearRegr.py train_data/baseGradFeats.csv train_data/basePropVals.csv 3 tmp/_nosigm_grad.pgm)"
SIGM_x0_SAL_VAL="$(python python/linearRegr.py train_data/baseGradFeats.csv train_data/basePropVals.csv 4 tmp/_nosigm_grad.pgm)"
