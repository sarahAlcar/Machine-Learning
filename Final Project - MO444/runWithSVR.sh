...
SIGM_STEEP_GRAD_VAL="$(python python/svr.py train_data/glcmGradFeats.csv train_data/glcmPropVals.csv 1 tmp/_nosigm_grad.pgm)"
SIGM_x0_GRAD_VAL="$(python python/svr.py train_data/glcmGradFeats.csv train_data/glcmPropVals.csv 2 tmp/_nosigm_grad.pgm)"
SIGM_STEEP_SAL_VAL="$(python python/svr.py train_data/glcmGradFeats.csv train_data/glcmPropVals.csv 3 tmp/_nosigm_grad.pgm)"
SIGM_x0_SAL_VAL="$(python python/svr.py train_data/glcmGradFeats.csv train_data/glcmPropVals.csv 4 tmp/_nosigm_grad.pgm)"
